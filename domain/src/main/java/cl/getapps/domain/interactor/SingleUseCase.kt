package cl.getapps.domain.interactor
 ...
 */
abstract class SingleUseCase<T, in Params>(private val threadExecutor: ThreadExecutor,
    ...
    /**
     *  Clear from curren [CompositeDisposable]
     */
    fun clear(){
